...
![Alt text](github/res/github-badcredential-token-expire.png "GitHub 토큰이 유출되어 자동으로 폐기된 후 해당 내용이 이메일로 수신됨.")   
...
![Alt text](github/res/github-badcredential-regenerate-token.png "GitHub 토큰 재발급을 위한 링크")
