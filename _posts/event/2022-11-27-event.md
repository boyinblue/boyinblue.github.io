...
{% include body-preview.html %}
<hr>{% assign preview_image_url = '' %}
{% assign preview_url = 'https://www.facebook.com/suhyupbank/posts/pfbid07TRk4oUx5wYs1xR91kefCWnQzqB9o7uLDGPrfDmfSKDBbgFtpEwhWubbaQ5Z1xKel' %}
{% assign preview_title = '' %}
{% assign preview_description = '' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://scontent-gmp1-1.cdninstagram.com/v/t39.30808-6/315770121_5740928655953239_5062593448384194518_n.png?stp=dst-jpg_s640x640&amp;_nc_cat=108&amp;ccb=1-7&amp;_nc_sid=8ae9d6&amp;_nc_ohc=8SWWchaPtnUAX9-Lcvi&amp;_nc_ht=scontent-gmp1-1.cdninstagram.com&amp;oh=00_AfC_ToBWEtszKpZ4uqGnVaKeA8BsradMDDyu5IIOtpX4Qg&amp;oe=6385B49F' %}
{% assign preview_url = 'https://www.instagram.com/p/ClVMevftzAA/' %}
{% assign preview_title = '' %}
{% assign preview_description = '' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://i.ytimg.com/vi/D8KMWTWzhrM/maxresdefault.jpg' %}
{% assign preview_url = 'https://www.youtube.com/watch?v=D8KMWTWzhrM' %}
{% assign preview_title = '[EVENT] 저축은행의 모든 것, 진실 혹은 오해! 💸🤔' %}
{% assign preview_description = '저축은행, #금리 만 높은 거 아냐~? 🤷‍♀️믿고 돈 맡길 수 있는거 맞아~?! 🤔#저축은행 에 대한 오해를시원~하게 풀어드리는 시간! 🤗💯저축은행, #진실 혹은 #오해재밌게 감상하시고 #퀴즈 도 풀어보세요! 📃📌Q. 저축은행이 문을 닫아도 원금과 소정의 이자를 합해최...' %}
{% include body-preview.html %}