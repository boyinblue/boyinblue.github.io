...
{% assign preview_description = '' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://scontent-gmp1-1.cdninstagram.com/v/t51.2885-15/327162395_710820293782213_4933503731807318372_n.jpg?stp=dst-jpg_s640x640&amp;_nc_cat=110&amp;ccb=1-7&amp;_nc_sid=8ae9d6&amp;_nc_ohc=BOBiIs8RNsoAX9JmY4t&amp;_nc_ht=scontent-gmp1-1.cdninstagram.com&amp;oh=00_AfDMqVPNcTIRk4lusy4QqnOXLqp5RqETD8TlDg2lTO9nkQ&amp;oe=63D78D0F' %}
{% assign preview_url = 'https://www.instagram.com/p/Cn0b-AVpExQ/' %}
{% assign preview_title = '' %}
{% assign preview_description = '' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = '' %}
{% assign preview_url = 'https://www.dailydaechi.com/elementary/ip/202301quizevent' %}
{% assign preview_title = '' %}
{% assign preview_description = '' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://blogthumb.pstatic.net/MjAyMzAxMjVfMjk5/MDAxNjc0NjM5NzE4MTQw.MGfGy2LS3n1cKOgAKE_fISqh-V6NMCqChBDZoQ33FSMg.mP2hRn480pZcmc7QVIE41Oe5Km91kCfpRHQgZOS-nTQg.JPEG.share-busan/%B0%F8%C0%AF%B0%E6%C1%A6%BA%CE%BB%EA_%BD%E6%B3%D7%C0%CF_%281%29.jpg?type=w2' %}
{% assign preview_url = 'https://blog.naver.com/share-busan/222993992246' %}
{% assign preview_title = '[유튜브 이벤트]2022 공유경제 활성화 지원사업 성과보고회 유튜브 시청 댓글 인증 이벤트★' %}
{% assign preview_description = '안녕하세요! 부산시민의 든든한 공유경제 파트너 &ldquo;공유경제부산&rdquo; 입니다. 나눌수록 쏠쏠한 공유경제부산 ...' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FFyxGp%2FbtrWKSRqDAk%2Ff2xyVxL86vc7btjnapFD0k%2Fimg.png' %}
{% assign preview_url = 'https://blog.paradise.co.kr/2150' %}
{% assign preview_title = '파라다이스 그룹 1월 블로그 이벤트 (4회차) &amp; 3회차 당첨자 발표' %}
{% assign preview_description = '파라다이스 그룹 1월 블로그 이벤트 2023년 새로운 시작을 맞이하는 1월! 파라다이스 그룹 블로그가 전하는 다양한 이야기와 함께 새해 복 많이 받으세요. 파라다이스 그룹 블로그의 다양한 콘텐츠를 확인하고 퀴즈 이벤트에 참여하시면 푸짐한 상품을 드립니다. ※ 퀴즈 Hint &amp; 이벤트 참여하기 -Hint: 바로가기[클릭] -이벤트: 참여하기[클릭] ※ 댓글로는 응모하실 수 없습니다. ※ 3회차 이벤트 당첨자 안내 임*신 (*106) 김*진 (*545) 이*훈 (*649) 노*옥 (*769) 한*호 (*973) ※ 당첨된 분들께는 2/1(수)까지 개별적으로 경품 발송 예정입니다.' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&amp;fname=https%3A%2F%2Ftistory1.daumcdn.net%2Ftistory%2F1777986%2Fattach%2Fab5b1b2331c747939df652843369aae3' %}
{% assign preview_url = 'https://www.samsungdigitalcity.com/category/%EC%A0%95%EB%B3%B4%EB%A5%BC%20%EC%A0%84%ED%95%98%EB%8B%A4/%EC%9D%B4%EB%B2%A4%ED%8A%B8' %}
{% assign preview_title = ''정보를 전하다/이벤트' 카테고리의 글 목록' %}
{% assign preview_description = '삼성전자 삼행시, 수원사회공헌센터 소개, 삼성 디지털시티, 수원&amp;middot;경기 지역 소식 제공' %}
{% include body-preview.html %}