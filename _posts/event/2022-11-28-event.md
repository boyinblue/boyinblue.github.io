...
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://lh4.googleusercontent.com/fp7Igjz9YaaT8PB-zB2FzqgrsIxhNu0VQamYFv7S26lzsTIlpwAGPiSgARyL9rPJMmsbkf6cuso=w1200-h630-p' %}
{% assign preview_url = 'https://www.samsungdigitalcity.com/2178' %}
{% assign preview_title = '[이벤트] 11월 이벤트 (4회차)' %}
...
{% include body-preview.html %}
<hr>{% assign preview_image_url = '' %}
{% assign preview_url = 'https://www.facebook.com/milknara/posts/pfbid02gVjg72ZGbJEj9HxpKW23PsTSf3rmLgBQ7ALLogUbvjV1ZPyJaanyskAJqDWsLjCzl' %}
{% assign preview_title = '' %}
{% assign preview_description = '' %}
{% include body-preview.html %}