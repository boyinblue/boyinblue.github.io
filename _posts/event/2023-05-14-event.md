...
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://www.hanbit.co.kr/data/event/3eb49e3d89f061ffa3ec942161dfd408.jpg' %}
{% assign preview_url = 'https://www.hanbit.co.kr/event/current/current_event_view.html?hbe_idx=183' %}
{% assign preview_title = '출간예정 도서 찜하고 찜한 도서 받고!' %}
{% assign preview_description = '출간예정 도서 찜하고 찜한 도서 받고!' %}
{% include body-preview.html %}