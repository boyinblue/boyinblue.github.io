...
{% assign preview_description = '' %}
{% include body-preview.html %}
<hr>{% assign preview_image_url = 'https://lh4.googleusercontent.com/mZUhJXpyJKpHF2QpcxTSZSx18z0oJvjGhHqI3swRKyuXYHg0cOAGJb1O9k77oisL2bFNo2-ElWE=w1200-h630-p' %}
{% assign preview_url = 'https://www.samsungdigitalcity.com/2175' %}
{% assign preview_title = '[이벤트] 11월 이벤트 (2회차)' %}
{% assign preview_description = '로드 중… ※이벤트 당첨자 정보는 [이름, 전화번호 뒷자리 4자리] 형식으로 발표됩니다. ※수집한 개인정보는 개인보호정책에 의해 보호되며, 경품 발송 및 연락 외의 용도로는 사용되지 않습니다.' %}
{% include body-preview.html %}