...
본 페이지에서는 터틀 그래픽을 통해서 간단한 그리기 예제들을 제공합니다. 


본 페이지에서 다루는 터틀 그래픽 메쏘드는 아래와 같습니다.
...
인자를 넣을때 주의할 점입니다.
1. 1에서부터 10까지 갈수록 점점 빨라짐.
2. 0은 최고 속도라는 것에 주의
3. 실수는 입력이 안됨. (ex : 0.5를 입력하면 0이 됨)
4. 10 이상의 값을 입력해도 10이상 빨라지지 않음


<code>turtle.setup(width=1024, height=768)</code> 구문은 
가로 1024 픽셀, 세로 768 픽셀
